...
class FlowLayout @JvmOverloads constructor(
    ...
    private var mChildSpacingForLastRow =
        DEFAULT_CHILD_SPACING_FOR_LAST_ROW
    ...
    private val mHorizontalSpacingForRow: MutableList<Float> =
        ArrayList()
